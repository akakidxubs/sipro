...
## 10) Tugas berikutnya (sesudah Fase 80)
1. Gate 61 `scripts/verify_p79_80.py` (amandemen, PDF, pengingat, RAB tipe/fasum, SPK dari RAB).
2. Kendali fasum berbasis progres fase konstruksi (termin SPK fasum mengikuti % fase, bukan hanya nilai kontrak).
3. RAB tipe: salin dari tipe lain / impor Excel; versi RAB tipe (riwayat perubahan harga satuan).
4. Amandemen komponen manual dari UI; paginasi panel pengingat tahap; backlog lama (engine.py 818>800, mutasi 53/54/56).
